...
<main>
    <div class="grid place-items-center p-2">
        ...
        {#each game.board[0][0].matrix as row, i (i)}
            {#each row as value, j (j)}
                <button class="col-span-1 border-2 border-white w-20 h-20 hover:bg-slate-600" 
    ...
    <div class="flex items-center space-x-4 justify-center p-2">
        <a class="border-2 border-solid rounded px-4 py-1
                 border-green-50 bg-green-600 hover:bg-green-500" href="/">
            Go back
        </a>

        <button class="border-2 border-solid rounded px-4 py-1
